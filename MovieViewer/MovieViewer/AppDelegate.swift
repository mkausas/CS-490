...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingViewController.endpoint = "popular"
        nowPlayingNavigationController.tabBarItem.title = "Popular"
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "iconmonstr-video-camera-9-240")
...
//        tabBarController.view.backgroundColor = UIColor(
